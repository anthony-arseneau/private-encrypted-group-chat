...
public class ChatClientListener {
    // Class constants
    static final private String SERVER_IP = "127.0.0.1"; // Server IP address ***** Change this value appropriately *****
    static final private int PORT_NUM = 12000; // Port number of the server
    ...
    private AESCipher aesCipher; // Utilize AES for fast message exchange
    ...
    public ChatClientListener(String username, String password) throws NoSuchAlgorithmException, InvalidKeySpecException, InvalidKeyException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException {
        try {
            ...
            this.socket = new Socket(SERVER_IP, PORT_NUM);
